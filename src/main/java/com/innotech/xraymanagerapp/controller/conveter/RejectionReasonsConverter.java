 ...
 * @author AlexcobarL
 */
@FacesConverter("rejectionReasonsConverter")
public class RejectionReasonsConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        AnnotationsBodyPartsController controller = (AnnotationsBodyPartsController) facesContext.getApplication().getELResolver().
                getValue(facesContext.getELContext(), null, "generalXrayController");
        return controller.getRejectionReason(getKey(value));
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof RejectionReasons) {
            RejectionReasons o = (RejectionReasons) object;
