(function (root, factory) {
    ...
    var has_VML, has_canvas, create_canvas_for, add_shape_to, clear_canvas, shape_from_area,
            canvas_style, hex_to_decimal, css3color, is_image_loaded, options_from_area, fill_area;
    ...
    fill_area = function (e,options,canvas,map) {
            ...
            $(map).bind('alwaysOn.maphilight', function () {
                ...
                $(map).find('area[coords]').each(function () {
                    ...
                    .bind('mouseover.maphilight focusin.maphilight', function (e){
                        fill_area(e,options, canvas, map);
